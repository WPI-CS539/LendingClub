...
names = ["id", "member_id", "loan_amnt", "funded_amnt", "funded_amnt_inv", "term", "int_rate", "installment",
...
names = list(set(names_all) - set(names_no))
data = pd.read_csv("accepted_2007_to_2017.csv", header=0, usecols=names, names=names)
data_df = pd.DataFrame(data)
# data_df.to_csv("clean_result.csv")
...
#     x = x.replace(" years", "").replace(" year", "").replace("\\+", "")
#     return int(x)
