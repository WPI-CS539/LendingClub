...
data = pd.read_csv("original.csv", header=0, usecols=names)
data_df = pd.DataFrame(data)
data_df = data_df[data_df['term'].notnull()]
data_df = data_df[data_df['emp_length'].notnull()]
data_df = data_df[data_df['verification_status'].notnull()]
